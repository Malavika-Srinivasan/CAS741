...
\wss{What modules are you testing?}
...
\begin{itemize}
	...
	\item Dr.Spencer Smith \wss{missing a space}
	\item Hanane Zlitni
\end{itemize}
...
NA \wss{why is this not applicable?  You don't have to do inspections, code
  walkthroughs etc, but you should say what it isn't applicable.  If the reason
  is a lack of time, that can be the reason you give.}
...
\wss{Please give the names of the modules so that they can be compared to the
  information (which you will add) in the Scope section.}
