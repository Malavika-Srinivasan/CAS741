...
The purpose of this document is to analyze the commonalities(assumptions which are true) and variabilities(assumptions which can vary) between the family of softwares produced as part of this library.
...
The reader of this document is expected to know the basic concepts of curve fitting. However to obtain a deeper understanding of this document, the reader is expected to be a undergraduate in science or engineering.
...
\item[A\refstepcounter{assumpnum}\theassumpnum \label{A_data}:] For the given set of data points $(t_i,y_i)$ where i $= 0,1,2,...n$, n $\geq 2$.(\rref{R_IInputs})
\item[A\refstepcounter{assumpnum}\theassumpnum \label{A_dataConstraint}:] For the given set of data points $(t_i,y_i)$ where i $= 0,1,2,...n$, $t_i < t_{i+1}$.(\iref{IM_HermiteCubic},\iref{IM_BSpline})
