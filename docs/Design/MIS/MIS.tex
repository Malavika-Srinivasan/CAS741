...
\begin{itemize}
	...
	of inFile is incorrect $\Longrightarrow$ FileError.\ms{I am yet to decide 
	if 
	the 
...
\subsubsection{State Variables}
\begin{itemize}
	\item x:$\mathbb{R}^{m \times n}$, \text{where $n$ is the number of data 
	points 
