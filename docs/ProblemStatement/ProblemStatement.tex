...
scientific computation problems are usually \wss{not usually - plenty of
scientific computing problems are solved without data acquisition systems}
from a data acquisition system, \wss{There should be a comma before which}
\ms{Yes Dr.Smith. I agree. Do you want me to change this sentence?} \wss{YES!}
...
The purpose of this software family\wss{say software family}\ms{correction made} is to 
develop a general purpose library \wss{say library} \ms{Correction made}for fitting the 
...
derivatives. \wss{say derivatives, gradient only refers to the first derivative}
\ms{Yes, correction made}
...
for the data, interpolating across the domain and computing derivatives. \wss{same
  comment as above on gradients} \ms{Changes made}This software can be run on a variety of
