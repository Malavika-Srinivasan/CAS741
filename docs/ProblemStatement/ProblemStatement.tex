...
The purpose of this software \wss{say software family} is to develop a general
purpose tool \wss{say library} for fitting the experimental data across a 1D
...
gradients. \wss{say derivatives, gradient only refers to the first derivative}
...
for the data, interpolating across the domain and computing gradients. \wss{same
  comment as above on gradients} This software can be run on a variety of
